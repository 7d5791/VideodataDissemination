...
void WaveShortMessage::copy(const WaveShortMessage& other)
{
    ...
    this->timestamp1_var = other.timestamp1_var;
...
void WaveShortMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->timestamp1_var);
...
void WaveShortMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->timestamp1_var);
...
simtime_t WaveShortMessage::getTimestamp1() const
{
    return timestamp1_var;
}

void WaveShortMessage::setTimestamp1(simtime_t timestamp1)
{
    this->timestamp1_var = timestamp1;
}
...
int WaveShortMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "timestamp1")==0) return base+14;
    if (fieldName[0]=='l' && strcmp(fieldName, "lastFrameReceived")==0) return base+15;
    if (fieldName[0]=='i' && strcmp(fieldName, "idVideo")==0) return base+16;
    if (fieldName[0]=='n' && strcmp(fieldName, "nodeType")==0) return base+17;
    if (fieldName[0]=='s' && strcmp(fieldName, "speed")==0) return base+18;
    if (fieldName[0]=='a' && strcmp(fieldName, "angleRad")==0) return base+19;
    if (fieldName[0]=='v' && strcmp(fieldName, "vecX")==0) return base+20;
    if (fieldName[0]=='v' && strcmp(fieldName, "vecY")==0) return base+21;
    if (fieldName[0]=='v' && strcmp(fieldName, "vecZ")==0) return base+22;
    if (fieldName[0]=='M' && strcmp(fieldName, "MulKjUjPowN")==0) return base+23;
    if (fieldName[0]=='K' && strcmp(fieldName, "KjUj")==0) return base+24;
    if (fieldName[0]=='c' && strcmp(fieldName, "carId")==0) return base+25;
    if (fieldName[0]=='t' && strcmp(fieldName, "timeIdleChannel")==0) return base+26;
    if (fieldName[0]=='h' && strcmp(fieldName, "hopCount")==0) return base+27;
...
std::string WaveShortMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 14: return double2string(pp->getTimestamp1());
        case 15: return long2string(pp->getLastFrameReceived());
        case 16: return long2string(pp->getIdVideo());
        case 17: return oppstring2string(pp->getNodeType());
        case 18: return double2string(pp->getSpeed());
        case 19: return double2string(pp->getAngleRad());
        case 20: return double2string(pp->getVecX());
        case 21: return double2string(pp->getVecY());
        case 22: return double2string(pp->getVecZ());
        case 23: return double2string(pp->getMulKjUjPowN());
        case 24: return double2string(pp->getKjUj());
        case 25: return long2string(pp->getCarId());
        case 26: return double2string(pp->getTimeIdleChannel());
        case 27: return long2string(pp->getHopCount());
        default: return "";
    }
}
...
bool WaveShortMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 14: pp->setTimestamp1(string2double(value)); return true;
        case 15: pp->setLastFrameReceived(string2long(value)); return true;
        case 16: pp->setIdVideo(string2long(value)); return true;
        case 17: pp->setNodeType((value)); return true;
        case 18: pp->setSpeed(string2double(value)); return true;
        case 19: pp->setAngleRad(string2double(value)); return true;
        case 20: pp->setVecX(string2double(value)); return true;
        case 21: pp->setVecY(string2double(value)); return true;
        case 22: pp->setVecZ(string2double(value)); return true;
        case 23: pp->setMulKjUjPowN(string2double(value)); return true;
        case 24: pp->setKjUj(string2double(value)); return true;
        case 25: pp->setCarId(string2long(value)); return true;
        case 26: pp->setTimeIdleChannel(string2double(value)); return true;
        case 27: pp->setHopCount(string2long(value)); return true;
